...
export function bookingConfirmed(ctx: {
  isFreeTrial?: boolean; subject?: string | null; whenISO?: string | null; tz?: string | null;
  durationMinutes?: number | null; tutorName?: string | null; appUrl?: string | null; bookingId: string;
}): RenderedEmail;
export function packagePurchased(ctx: { minutes: number; amountCents: number; balanceMinutes?: number | null; appUrl?: string | null }): RenderedEmail;
export function reminder(ctx: {
  role: "customer" | "tutor"; kind: "24h" | "1h"; subject?: string | null; whenISO?: string | null; tz?: string | null;
  tutorName?: string | null; studentName?: string | null; appUrl?: string | null; bookingId: string;
}): RenderedEmail;
...
export function tutorNewSession(ctx: {
  subject?: string | null; whenISO?: string | null; tz?: string | null; durationMinutes?: number | null;
  studentName?: string | null; appUrl?: string | null; bookingId: string;
}): RenderedEmail;
export function tutorCancelled(ctx: { early: boolean; subject?: string | null; whenISO?: string | null; tz?: string | null }): RenderedEmail;
