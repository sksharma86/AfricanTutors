  ...
  const [{ data: pending }, { data: subjects }, { data: tutorRows }, { data: tutorSubjects }, { data: bookings }] =
    await Promise.all([
      ...
      supabase!
        .from("bookings")
        .select(
          "id, public_reference, subject_name, other_subject_text, student_first_name, tutor_display_name, scheduled_start, duration_minutes, status, is_free_trial, price_cents",
        )
