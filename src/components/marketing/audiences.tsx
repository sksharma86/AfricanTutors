    ...
    <section className="py-20">
      <Container className="grid gap-6 md:grid-cols-2">
        <Card className="p-8">
          ...
          <h2 className="mt-2 font-display text-2xl font-semibold text-ink-900">Academic time, on your schedule.</h2>
        ...
        <Card className="p-8">
          ...
          <p className="mt-5 text-xs leading-5 text-ink-400">
            Study Hall is focused academic time with accountability — not subject-by-subject tutoring.
          </p>
        </Card>
      </Container>
    </section>
