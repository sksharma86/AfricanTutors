    ...
    <section className="py-20">
      <Container className="grid gap-6 md:grid-cols-2">
        <Card className="p-8">
          ...
          <h2 className="mt-2 font-display text-2xl font-semibold text-ink-900">Homework support, on your schedule.</h2>
        ...
        <Card className="p-8">
          ...
          <h2 className="mt-2 font-display text-2xl font-semibold text-ink-900">Get your evenings back.</h2>
          <ul className="mt-5 space-y-3">
          ...
          <p className="mt-5 text-xs leading-5 text-ink-400">
            Study Hall is homework supervision and accountability — not subject-by-subject tutoring.
          </p>
        </Card>
      </Container>
    </section>
